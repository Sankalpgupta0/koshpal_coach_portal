    ...
    try {
      ...
      const upcomingFiltered = allConsultations
        ...
        .map(consultation => ({
          ...
          // Additional fields for ClientOverview
          client: {
            id: consultation.booking?.employee?.id,
            name: consultation.booking?.employee?.fullName || 'Unknown Client',
            role: 'Employee',
            company: consultation.booking?.employee?.company || 'N/A',
            lastSession: 'N/A', // Details will be fetched on profile page
            nextSession: formatDate(consultation.startTime)
          }
        }));
                          ...
                          {upcomingSessions.length === 0 ? (
                            ...
                            upcomingSessions.map((session, idx) => (
                              ...
                              >
                                ...
                                <button
                                  onClick={() => handleViewClient(session.client)}
