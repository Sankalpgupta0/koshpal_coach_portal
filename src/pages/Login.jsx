      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3 sm:mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={loading}
                className="w-full pl-9 sm:pl-10 pr-4 py-2.5 sm:py-3 text-sm sm:text-base rounded-lg focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed"
                style={{
          ...
          <div className="mb-3 sm:mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={loading}
                className="w-full pl-9 sm:pl-10 pr-10 sm:pr-12 py-2.5 sm:py-3 text-sm sm:text-base rounded-lg focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed"
                style={{
                  backgroundColor: 'var(--color-input-bg)',
                  border: '1px solid var(--color-input-border)',
                  color: 'var(--color-input-text)',
          ...
          <div className="flex items-center justify-between mb-5 sm:mb-6 gap-2">
            <label className="flex items-center flex-shrink-0">
              <input
                ...
                disabled={loading}
                className="w-3.5 h-3.5 sm:w-4 sm:h-4 rounded flex-shrink-0 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                style={{
          ...
          <button
            type="submit"
            disabled={loading}
            className="cursor-pointer w-full font-semibold py-2.5 sm:py-3 text-sm sm:text-base rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            style={{
